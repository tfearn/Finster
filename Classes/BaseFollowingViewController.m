...
@interface BaseFollowingViewController (Private)
- (void)getData;
@end


@implementation BaseFollowingViewController
...
- (void)getData {
	_request = [ASIHTTPRequest requestWithURL:[self getUrl]];
...
- (void)requestFinished:(ASIHTTPRequest *)request {
	...
	NSArray *following = [dict objectForKey:[self getReturnedDataRootKey]];
